...
var file_UserService_user_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0x9b, 0x05, 0x0a, 0x0b, 0x55, 0x73, 0x65,
...
var file_UserService_user_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
...
var file_UserService_user_proto_depIdxs = []int32{
	...
	7,  // 8: user.UserService.GetUserById:input_type -> user.GetUserByIdRequest
	9,  // 9: user.UserService.GetUserByEmail:input_type -> user.GetUserByEmailRequest
	11, // 10: user.UserService.DeleteUser:input_type -> user.DeleteUserRequest
	13, // 11: user.UserService.GetAllUsers:input_type -> user.GetAllUsersRequest
	15, // 12: user.UserService.GetUsersByRole:input_type -> user.GetUsersByRoleRequest
	17, // 13: user.UserService.AddUserRoles:input_type -> user.AddUserRolesRequest
	19, // 14: user.UserService.RemoveUserRoles:input_type -> user.RemoveUserRolesRequest
	1,  // 15: user.UserService.CreateUser:output_type -> user.CreateUserResponse
	3,  // 16: user.UserService.UpdateUser:output_type -> user.UpdateUserResponse
	8,  // 17: user.UserService.GetUserById:output_type -> user.GetUserByIdResponse
	10, // 18: user.UserService.GetUserByEmail:output_type -> user.GetUserByEmailResponse
	12, // 19: user.UserService.DeleteUser:output_type -> user.DeleteUserResponse
	14, // 20: user.UserService.GetAllUsers:output_type -> user.GetAllUsersResponse
	16, // 21: user.UserService.GetUsersByRole:output_type -> user.GetUsersByRoleResponse
	18, // 22: user.UserService.AddUserRoles:output_type -> user.AddUserRolesResponse
	20, // 23: user.UserService.RemoveUserRoles:output_type -> user.RemoveUserRolesResponse
